...
EasyDB is a user-friendly database utility that wraps Sqlite in an easy-to-use JavaScript API. What makes EasyDB so easy you ask? Well, you get all ot the great functionality of a Sqlite database without having to know or write SQL! It provides simple javascript functions for performing SQL commands like `CREATE`, `SELECT`, `UPDATE`, and `DELETE` without even having to write a single line of SQL.

**Repository:** [https://github.com/alaneicker/easy-db](https://github.com/alaneicker/easy-db)

## Setup

#### Install Sqlite and EasyDB

```
npm i -S sqlite @alaneicker/easy-db
```
...
<img src="https://raw.githubusercontent.com/alaneicker/easy-db/master/cli-screen-1.png" width="550" alt="CLI Screenshot">

<img src="https://raw.githubusercontent.com/alaneicker/easy-db/master/cli-screen-2.png" width="550" alt="CLI Screenshot">

<img src="https://raw.githubusercontent.com/alaneicker/easy-db/master/cli-screen-3.png" width="550" alt="CLI Screenshot">
